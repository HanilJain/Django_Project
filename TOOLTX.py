...
print("")
print(color.lightblue+color.BOLD+"       ===================================================="+color.END)
print("")                                  
print(color.YELLOW+color.BOLD+"            [=] TooLTX WILL PROVIDE YOU ALL TOOLS [=]"+color.END)
print(color.YELLOW+color.BOLD+"            [=]           FOR PENTESTING          [=]"+color.END)
print(color.YELLOW+color.BOLD+"            [=]                 IN                [=]"+color.END)
print(color.YELLOW+color.BOLD+"            [=]           LINUX / TERMUX          [=]"+color.END)   
print("")
print(color.lightblue+color.BOLD+"       ===================================================="+color.END)
print("")
...
print (color.RED+color.BOLD+'''
          ************************************************
          !                                              !
          !  ==> Press 1 to view All Categories of tool  !
          !                                              !
...
********************************************************************
			 ...
			 '''+color.END)
						print(color.BLUE+color.BOLD+"     { WHICH TOOL YOU WANT TO DOWNLOAD FROM THE ABOVE CATEGORIES } "+color.END)
						opcion1 = input("                                 = ")
						#if opcion1 == "back":
							#inicio1()
						#elif opcion1 == "gohome":
...
0) Install all Information Gathering tools
						...
						'''+color.END)
							#
							opcion2 = input(color.lightgreen+color.BOLD+"Insert the number of the tool Which you want to install it = "+color.END)
							if opcion2 == "1":
