...
def logo():
  ...
  sSSs   .S S.    .S_sSSs    sdSS_SSSSSSbs   .S   .S_sSSs      sSSs  
 d%%SP  .SS SS.  .SS~YS%%b   YSSS~S%SSSSSP  .SS  .SS~YS%%b    d%%SP  
d%S'    S%S S%S  S%S   `S%b       S%S       S%S  S%S   `S%b  d%S'    
S%|     S%S S%S  S%S    S%S       S%S       S%S  S%S    S%S  S%S     
S&S     S%S S%S  S%S    S&S       S&S       S&S  S%S    S&S  S&S     
Y&Ss     SS SS   S&S    S&S       S&S       S&S  S&S    S&S  S&S_Ss  
`S&&S     S S    S&S    S&S       S&S       S&S  S&S    S&S  S&S~SP  
  `S*S    SSS    S&S    S&S       S&S       S&S  S&S    S&S  S&S     
   l*S    S*S    S*S    S*S       S*S       S*S  S*S    d*S  S*b     
  .S*P    S*S    S*S    S*S       S*S       S*S  S*S   .S*S  S*S.    
sSS*S     S*S    S*S    S*S       S*S       S*S  S*S_sdSSS    SSSbs  
YSS'      S*S    S*S    SSS       S*S       S*S  SSS~YSSY      YSSP  
          SP     SP               SP        SP                       
          Y      Y                Y         Y                        
